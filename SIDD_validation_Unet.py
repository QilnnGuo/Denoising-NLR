...
def write_log(filename, message, output_dir="./output_logs/UNET/validation_1_mask0.3_UNET"):
...
def train_model(filename, path_CL, path_RN, output_dir):
    ...
    best_psnr = 0
    save_iterations = [i for i in range(0, 2001, 100)]
...
def main(path_CL='./SIDD_subset/CL', path_RN='./SIDD_subset/RN', output_dir="./output_logs/UNET/validation_1_mask0.3_UNET"):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Zero-Shot Blind-spot Denoising via Pixel Refilling - SIDD Validation with UNET')
    ...
    parser.add_argument('--output_dir', type=str, default="./output_logs/UNET/validation_1_mask0.3_UNET", help='Directory to save output logs and images')
